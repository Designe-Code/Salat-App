...
class EveningScreenDikr extends StatefulWidget {
  const EveningScreenDikr({super.key});

  @override
  State<EveningScreenDikr> createState() => _EveningDikrScreenState();
}

class _EveningDikrScreenState extends State<EveningScreenDikr> {
