...
class _QuranImageContainerState extends State<QuranImageContainer> {
  ...
  void initState() {
    ...
    quranController.isPageInPagesBookMarksList(widget.initialPage)
      .then((value) {
              ...
              return CarouselSlider.builder(
                options: CarouselOptions(
                  ...
                  onPageChanged: (pageViewIndex, carouselPageChangedReason) {
                    ...
                    quranController.isPageInPagesBookMarksList(pageViewIndex + 1)
                      .then((value) => quranProvider.setIsBookMarkActive(value));
                  }
                ),
                itemCount: 603,
