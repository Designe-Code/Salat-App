...
class JuzItem extends StatelessWidget {
  const JuzItem({super.key, required this.juz});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          navigateTo(context, QuranImageScreen(page: juz.pageOfFirstVerse));
        },
        child: Column(
          children: [
            Container(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Surat ${juz.firstSurahName}, Ayah ${juz.firstVerseNumber}',
